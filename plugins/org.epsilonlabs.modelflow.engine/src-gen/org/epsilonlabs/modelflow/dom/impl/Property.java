 ...
 * </p>
 * <ul>
 *   <li>{@link org.epsilonlabs.modelflow.dom.impl.Property#getKey <em>Key</em>}</li>
 *   <li>{@link org.epsilonlabs.modelflow.dom.impl.Property#getValue <em>Value</em>}</li>
 *   <li>{@link org.epsilonlabs.modelflow.dom.impl.Property#getEvaluatedValue <em>Evaluated Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Property extends MinimalEObjectImpl.Container implements IProperty {
	...
	protected EClass eStaticClass() {
		return IDomPackage.Literals.PROPERTY;
	}
	...
	public void setKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IDomPackage.PROPERTY__KEY, oldKey, key));
	}
	...
	public void setValue(Object newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IDomPackage.PROPERTY__VALUE, oldValue, value));
	}
	...
	public void setEvaluatedValue(Object newEvaluatedValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IDomPackage.PROPERTY__EVALUATED_VALUE, oldEvaluatedValue, evaluatedValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomPackage.PROPERTY__KEY:
				return getKey();
			case IDomPackage.PROPERTY__VALUE:
				return getValue();
			case IDomPackage.PROPERTY__EVALUATED_VALUE:
