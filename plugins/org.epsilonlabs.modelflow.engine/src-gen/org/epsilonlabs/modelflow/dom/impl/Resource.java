 ...
 * </p>
 * <ul>
 *   <li>{@link org.epsilonlabs.modelflow.dom.impl.Resource#getDeclared <em>Declared</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Resource extends AbstractResource implements IResource {
	...
	protected EClass eStaticClass() {
		return IDomPackage.Literals.RESOURCE;
	}
	...
	public void setDeclared(Boolean newDeclared) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IDomPackage.RESOURCE__DECLARED, oldDeclared, declared));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomPackage.RESOURCE__DECLARED:
				return getDeclared();
		}
