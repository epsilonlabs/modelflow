...
public interface IResourceManager {
	 ...
	 */
	void processResourcesBeforeExecution(ITaskNode tNode, IModelFlowContext ctx) throws MFRuntimeException;

	/** 
	 * This method is called after the task has been executed.
	 * @throws MFRuntimeException 
	 */
	void processResourcesAfterExecution(ITaskNode tNode, IModelFlowContext ctx) throws MFRuntimeException;
